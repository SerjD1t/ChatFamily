...
1. Администратор открывает «Администрирование», указывает e-mail, права и создаёт приглашение.
2. Новый пользователь на странице входа нажимает «Есть одноразовый код?», вводит полученный код, имя и новый пароль.
3. После принятия приглашения пользователь автоматически входит в чат. Код действует один раз и не должен передаваться в общих чатах.
