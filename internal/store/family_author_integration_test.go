...
func TestFamilyAuthorLabels(t *testing.T) {
 ...
 INSERT INTO conversations(id,kind,family_id) VALUES('test_label_c1','family','test_label_f1'),('test_label_c2','family','test_label_f2'),('test_label_direct','direct',NULL),('test_label_group','group','test_label_f1');`)
	...
	for cid, want := range map[string]string{"test_label_c1": "Test · Мама", "test_label_c2": "Test · Бабушка", "test_label_direct": "Test Surname", "test_label_group": "Test Surname"} {
		var got string
	...
	for _, status := range []string{"", "Неопределено"} {
